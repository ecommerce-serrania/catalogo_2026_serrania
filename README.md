...
- **JPG o WebP**, 1200 × 1500 px vertical, **máximo 150 KB** cada una. El sitio acepta los dos formatos.
- Convierte en **squoosh.app** sin instalar nada.
- Nombre en minúscula, sin tildes ni espacios: el `id` del producto + guion + número.

```
cyclone-1.jpg   cyclone-2.jpg   cyclone-3.jpg
```

Los servidores distinguen mayúsculas: `Cyclone-1.jpg` no funciona.
...
## Qué hace el sitio en celular

El encabezado ocupa una sola fila: logo a la izquierda, botón de menú a la derecha. **El buscador vive dentro del menú**, junto con las categorías en dos columnas y la opción "Todas".

La barra de filtros solo muestra el filtro por uso, porque las categorías ya están en el menú y repetirlas ocupaba media pantalla.

Los logos de clientes se ven a color desde el principio, sobre placa blanca en el hero. En computador van en blanco y revelan su color al pasar el mouse.

## Controles de los carruseles

**Tarjetas del catálogo.** En computador las fotos avanzan solas al pasar el mouse, y aparecen dos flechas más los puntos clicables para controlarlas a mano. Al retirar el mouse vuelven al modo automático. En celular se deslizan con el dedo, y si deslizas en vez de tocar no se abre la ficha.

**Cinta de marcas.** Anda sola. Los tres botones de abajo permiten retroceder, pausar y avanzar. Al usarlos se congela donde iba; el botón central la devuelve al movimiento automático.

**Ficha de producto.** Flechas, puntos y miniaturas. Al hacer clic sobre la foto se abre a pantalla completa, con navegación por teclado y cierre con Esc.
